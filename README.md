...
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/miniscruff/igloo/CI?style=flat-square)](https://github.com/miniscruff/igloo/actions?query=workflow%3Aunit+test+and+coverage)
